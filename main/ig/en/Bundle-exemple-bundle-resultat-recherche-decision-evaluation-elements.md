...
{
  "resourceType" : "Bundle",
  "id" : "exemple-bundle-resultat-recherche-decision-evaluation-elements",
  "meta" : {
    "profile" : ["https://interop.esante.gouv.fr/ig/fhir/sdo/StructureDefinition/esms-bundle-resultat-recherche-decision-evaluation"]
  },
  "type" : "searchset",
  "entry" : [{
    "fullUrl" : "https://example.com/base/DocumentReference/exemple-esms-documentreference-1-in-bundle-elements",
    "resource" : {
      "resourceType" : "DocumentReference",
      "id" : "exemple-esms-documentreference-1-in-bundle-elements",
      "meta" : {
  ...
  {
    "fullUrl" : "https://example.com/base/DocumentReference/exemple-esms-documentreference-2-in-bundle-elements",
    "resource" : {
      "resourceType" : "DocumentReference",
      "id" : "exemple-esms-documentreference-2-in-bundle-elements",
      "meta" : {
