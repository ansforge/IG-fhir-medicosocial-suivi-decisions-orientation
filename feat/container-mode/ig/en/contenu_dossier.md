...
| 6 | ……modePriseEnCharge : Code | [0..1] | PriseCharge.modePriseCharge |  JDV_J264-ModeEtCentreDePriseEnCharge-MDPH harmonisée avec la nomenclature CNSA  No_Mode_prise_en_chargeOID et codes NOS à utiliser et leurs équivalences dans la nomenclature CNSA- (1.2.250.1.213.3.3.13) Code 46 " Hébergement (accueil jour et nuit) " = "Internat (1)" - (1.2.250.1.213.3.3.13) Code 47 " Accueil de jour" = "externat (2), semi-internat (3) ou accueil de jour (6)" - (1.2.250.1.213.3.3.13) Code 48 "Accueil de nuit " = "Accueil de nuit (4)" - (1.2.250.1.213.1.6.1.8) Code 238 "Centre d'Accueil Familial Spécialisé " = "Centre d'accueil familial spécialisé (5)" |
