...
* ^meta.profile = "https://hl7.org/fhir/R4/StructureDefinition/shareablecodesystem"
* ^caseSensitive = true 
* ^compositional = false
* ^content = #complete
* ^experimental = false
...
* #dateStatutESMS "dateStatutESMS" "Permet de définir la date d'entrée dans le statut"
...
* #dateStatutUnite "dateStatutUnite" "Permet de définir la date d'entrée renseignée par l'utilisateur pour les statuts"
